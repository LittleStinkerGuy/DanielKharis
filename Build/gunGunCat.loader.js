    ...
    var f,
        ...
        C = {
            ...
            GetMemoryInfo: function () {
                var e = l._getMemInfo();
                return { totalWASMHeapSize: l.HEAPU32[e >> 2], usedWASMHeapSize: l.HEAPU32[1 + (e >> 2)], totalJSHeapSize: l.HEAPF64[1 + (e >> 3)], usedJSHeapSize: l.HEAPF64[2 + (e >> 3)] };
            },
        };
    function k(e, t, n) {
    ...
    function D(e, t) {
        if ("symbolsUrl" != e) {
            var n = l.downloadProgress[e],
                r = ((n = n || (l.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })), "object" != typeof t || ("progress" != t.type && "load" != t.type) || (n.started || ((n.started = !0), (n.lengthComputable = t.lengthComputable)), (n.total = t.total), (n.loaded = t.loaded), "load" == t.type && (n.finished = !0)), 0),
                o = 0,
                a = 0,
                i = 0,
                s = 0;
    ...
    (l.SystemInfo = (function () {
        ...
        (l.readBodyWithProgress = function (a, i, s) {
            var e = a.body ? a.body.getReader() : void 0,
                ...
                f = 0;
            return (
                c || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."),
                (function o() {
                    return void 0 === e
                        ? a.arrayBuffer().then(function (e) {
                              var t = new Uint8Array(e);
                              return i({ type: "progress", response: a, total: e.length, loaded: 0, lengthComputable: c, chunk: s ? t : null }), t;
                          })
                        : e.read().then(function (e) {
                              ...
                              return h + e.value.length <= u.length ? (u.set(e.value, h), (f = h + e.value.length)) : l.push(e.value), (h += e.value.length), i({ type: "progress", response: a, total: Math.max(d, h), loaded: h, lengthComputable: c, chunk: s ? e.value : null }), o();
                          });
                })().then(function (e) {
                    return i({ type: "load", response: a, total: e.length, loaded: e.length, lengthComputable: c, chunk: null }), (a.parsedBody = e), a;
                })
            );
        }),
                ...
                function d(n, r) {
                    return fetch(n, r).then(function (e) {
                        ...
                        return !c.enabled || c.revalidated
                            ...
                            : (x("'" + s + "' request failed with status: " + e.status + " " + e.statusText), S(e, r.onProgress, r.enableStreamingDownload));
                    });
                }
                return (
                    a && ((c.control = a.control), (c.companyName = a.companyName), (c.productName = a.productName), (c.productVersion = a.productVersion)),
                    (c.revalidated = !1),
                    ...
                    c.enabled
                        ? i
                                  ...
                                  return e
                                      ? ((n = e.response),
                                        ...
                                        "immutable" == c.control
                                            ...
                                            : ((e = s),
                                              ((t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0)) || (!n.headers.get("Last-Modified") && !n.headers.get("ETag"))
                                                  ? ((e = (a = a || {}).headers || {}), (a.headers = e), n.headers.get("Last-Modified") ? ((e["If-Modified-Since"] = n.headers.get("Last-Modified")), (e["Cache-Control"] = "no-cache")) : n.headers.get("ETag") && ((e["If-None-Match"] = n.headers.get("ETag")), (e["Cache-Control"] = "no-cache")), d(o, a))
                                                  : fetch(s, { method: "HEAD" }).then(function (t) {
                                                        return (
                                                            (c.revalidated = ["Last-Modified", "ETag"].every(function (e) {
                                                            ...
                                                            c.revalidated
                                                                ? (i.updateRequestMetaData(r).then(function () {
                                                                  ...
                                                                  S(c.response, a.onProgress, a.enableStreamingDownload))
                                                                : d(o, a)
                                                        );
                                                    })))
                                      : d(o, a);
                              ...
                              .catch(function (e) {
                                  return x("Failed to load '" + c.metaData.url + "' from indexedDB cache due to the error: " + e), y(o, a);
                              })
                        : y(o, a)
                );
            }));
                        ...
                        try {
                            for (var n in E) {
                                ...
                                if (E[n].hasUnityMarker(i))
                                    return (
                                        s && console.log('You can reduce startup time if you configure your web server to add "Content-Encoding: ' + n + '" response header when serving "' + s + '" file.'),
                                        (r = E[n]).worker ||
                                            ((o = URL.createObjectURL(
                                                new Blob(
                                                    [
                                                        ...
                                                        "; this.onmessage = ",
                                                        function (e) {
                                                            e = { id: e.data.id, decompressed: this.decompress(e.data.compressed) };
                    ...
                    (i.src = s),
                        (i.onload = function () {
                            if ("undefined" == typeof unityFramework || !unityFramework) {
                                ...
                                d("Unable to parse " + l.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error");
                            }
                            var o = unityFramework;
                            (unityFramework = null), (i.onload = null), URL.revokeObjectURL(s), a(o);
                        }),
                        (i.onerror = function (e) {
                            d("Unable to load file " + l.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error");
                        }),
    ...
    return new Promise(function (e, t) {
        ...
        l.SystemInfo.hasWebGL
            ? 1 == l.SystemInfo.hasWebGL
                ? ((n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.'), "Safari" == l.SystemInfo.browser && parseInt(l.SystemInfo.browserVersion) < 15 && (l.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? (n += "\nUpgrade to iOS 15 or later.") : (n += "\nUpgrade to Safari 15 or later.")), t(n))
